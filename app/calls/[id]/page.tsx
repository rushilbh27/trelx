        ...
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <span className={errors.length > 0 ? severityText(critical > 0 ? "critical" : "high") : "text-emerald-300"}>{status}</span>
          ...
          <section className="border border-white/10 bg-black p-5">
            ...
            {errors.length === 0 ? (
              <div className="mt-4 border border-emerald-300/20 bg-emerald-950/10 p-4 text-sm text-emerald-200">
                {call.analyzed ? "No material failures detected for this call." : "Call not analyzed yet. Dashboard pipeline will pick it up."}
              </div>
            ) : (
